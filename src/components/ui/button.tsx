    ...
    return (
      <button
        className={cn(
          ...
          {
            "bg-glam-gradient text-black hover:shadow-lg hover:shadow-glam-purple/30 hover:scale-105":
              variant === "gradient",
            "border border-white/20 bg-transparent text-white hover:bg-white/10 hover:border-glam-purple/40":
              variant === "outline",
