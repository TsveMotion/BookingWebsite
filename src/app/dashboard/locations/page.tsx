...
import { MapPin, Plus, Edit2, Trash2, Users, Lock, Crown, Building, LinkIcon, X, Save, ChevronDown, ChevronUp, Clock } from "lucide-react";
...
export default function LocationsPage() {
  ...
  // Free: 1 location, Pro: 3 locations, Business: unlimited
  const locationLimit = isBusiness ? Infinity : isPro ? 3 : 1;
  const canAddLocation = locations.length < locationLimit;

  const handleSaveWorkingHours = async (locationId: string, hours: any) => {
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-2">
                <span className="text-xs px-2 py-1 rounded-full bg-white/10 text-white/70">
                  {isFree && "Free: 1 location"}
                  {isPro && `Pro: Up to 3 locations (${locations.length}/3)`}
                  {isBusiness && "Business: Unlimited locations"}
                </span>
              </div>
            </div>
            {canAddLocation ? (
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-white/70 mb-4">
                  ...
                  {isFree && "Upgrade to Pro for up to 3 locations, or Business for unlimited locations."}
                  {isPro && "Upgrade to Business to add unlimited locations and assign staff to different branches."}
                </p>
                <motion.button
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-2">
                    <motion.button
                      ...
                      className="flex-1 px-4 py-2 bg-lavender/20 text-white font-semibold rounded-lg hover:bg-lavender/30 transition-colors flex items-center justify-center gap-2 border border-lavender/30"
                    >
